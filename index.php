    ...
    <section class="work">
        <div class="work__gallery">
            ...
            <div class="work__item small__item set-bg" data-setbg="img/work/work3.jpeg">
                <a href="https://www.youtube.com/watch?v=outUu1wL03s" class="play-btn video-popup"><i
                        class="fa fa-play"></i></a>
                <div class="work__item__hover">
                    <h4>NRI Wives </h4>
                    <ul>
            ...
            <div class="work__item large__item set-bg" data-setbg="img/work/work4.jpg" style="background-position: top right;">
                <a href="https://www.youtube.com/watch?v=bkEOR5qD6zA" class="play-btn video-popup"><i
                        class="fa fa-play"></i></a>
                <div class="work__item__hover">
                    <h4>Dedh Bigha Zameen </h4>
                    <ul>
                        <!-- <li>Romance</li> -->
                        <li>Marathi</li>
                    </ul>
            ...
            <div class="work__item wide__item set-bg" data-setbg="img/work/work-7.jpg">
                <a href="https://www.youtube.com/watch?v=3Ut8ts6g-OE" class="play-btn video-popup"><i
                        class="fa fa-play"></i></a>
                <div class="work__item__hover">
                    <h4>Thug Life </h4>
                    <ul>
